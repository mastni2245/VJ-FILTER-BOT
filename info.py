...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001976637175'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1367267970').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002025089247').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002247492132') # give your force subscribe channel id here else leave it blank
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'likesnaidu') # owner username without @
